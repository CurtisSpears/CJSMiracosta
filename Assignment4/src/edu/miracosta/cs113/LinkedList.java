...
***********************************************************************
* TITLE:				LinkedList<T>
* PROGRAM DESCRIPTION:	Constructor class to create and manipulate a linked list
***********************************************************************/

package edu.miracosta.cs113;

//Imports
import java.util.AbstractSequentialList; //LinkedList Implements
...
public class LinkedList<T> extends AbstractSequentialList<T>{
	...
	/** LinkedList: Filled Constructor for LinkedList
	 * @param int size, Node<T> head, Node<T> tail
	 * @return n/a
	 */
	public LinkedList(int size, Node<T> head, Node<T> tail) {
		this.setSize(size);
		this.head = head;
		this.tail = tail;
	}
	...
	//Other Methods *******************************
	/** clone : returns clone of this LinkedList
	 * @param n/a
	 * @return LinkedList<T> clone
	 */
	public LinkedList<T> clone() {
		return new LinkedList<T>(this);
	}
	
	/** equals : returns boolean representation of LinkedList equality
	 * @param LinkedList<T> other
   ...
   public ListIterator<T> listIterator(int index) {
	...
	private class Iterator implements ListIterator<T>{
		...
		public Iterator(int targetIndex) {
			if(targetIndex == 0) {
			...
			else if(targetIndex > LinkedList.this.getSize() || index < 0) {
				...
				this.lastItemReturned = LinkedList.this.getTail(); 
				this.nextItem = null;
			}
			else {
		...
		public boolean equals(Iterator other) {
			if(other == null || !(other instanceof LinkedList.Iterator)) {
				return false;
			}
